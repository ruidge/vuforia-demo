...
public class Luffy extends MeshObject {
    ...
    public Luffy(AssetManager inputassetManager){
...
//                将一行分成3个数据
    ...
    private void setVerts(){
        int num = 0;
        try{
            num = loadVertsFromModel("luffy/verts.txt");
    ...
    private void setTexCoords()
    {
        int num = 0;
        try {
            num = loadTexCoordsFromModel("luffy/texcoords.txt");
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    private void setNorms()
    {
        int num = 0;
        try {
            num = loadNormsFromModel("luffy/norms.txt");
        } catch (IOException e) {
            e.printStackTrace();
        }
