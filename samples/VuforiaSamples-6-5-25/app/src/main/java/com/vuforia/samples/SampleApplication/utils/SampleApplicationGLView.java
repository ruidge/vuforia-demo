...
public class SampleApplicationGLView extends GLSurfaceView {
    ...
    private ImageTargetRenderer mImageTargetRenderer;

    public void setImageTargetRenderer(ImageTargetRenderer mImageTargetRenderer) {
        this.mImageTargetRenderer = mImageTargetRenderer;
    ...
    public boolean onTouchEvent(MotionEvent e) {
        ...
        switch (e.getAction()) {
            case MotionEvent.ACTION_MOVE:
                ...
                float angle = mImageTargetRenderer.getAngle() +
                        ((dx + dy) * TOUCH_SCALE_FACTOR);
                mImageTargetRenderer.setAngle(angle);
                Log.d("ruidge", "onTouchEvent angle : " + angle);
                requestRender();
        }
